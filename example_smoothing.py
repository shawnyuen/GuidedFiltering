# -*- coding: utf-8 -*-
"""
Created on Thu Aug 31 21:12:02 2017
...
def main():
    img_name = './img_smoothing/cat.bmp'
    img_smoothed_name = './img_smoothing/cat_smoothed.bmp'
    ...
    p = img
    q = guidedfilter(img, p, r, eps)
    scipy.misc.imsave(img_smoothed_name, q)
    plt.figure(2)
