# -*- coding: utf-8 -*-
"""
Created on Thu Aug 31 21:03:56 2017
...
def main():
    img_flash_name = './img_flash/cave-flash.bmp'
    img_noflash_name = './img_flash/cave-noflash.bmp'
    img_result_name = './img_flash/cave-result.bmp'
    print("Loading images", img_flash_name, img_noflash_name)
    img_flash = scipy.misc.imread(img_flash_name).astype(np.float64)/255
    img_noflash = scipy.misc.imread(img_noflash_name).astype(np.float64)/255
    (hei, wid, dim) = img_flash.shape
